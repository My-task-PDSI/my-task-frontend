<template>
  <div>
    ...
    <div class="signupContainer">
      <div class="headerMsg">
        <h4 class="title">Bem vindo(a) ao My Tasks</h4>
        <br />
        <span class="msg"
          >Vamos ajudá-lo a organizar suas tarefas. <br />
          Cadastre-se já!</span
        >
        <br />
      </div>
      ...
      />
      <br />
      <Button msg="Cadastre-se" v-on:click="signup" /> <br />
      <br />
      <span
        >Já possui uma conta?
        <router-link to="/login"><button>Faça login</button></router-link></span
      >
    </div>
  </div>
</template>
  ...
  methods: {
    signup() {
      if (this.newUser.name == "" || this.newUser.email == "") {
        ...
        Api.post("user/signup", this.newUser)
          .then((response) => {
